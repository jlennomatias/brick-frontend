    ...
    <div class="main-container">
        ...
        <q-form @submit.prevent="approveConsent">
            ...
            <div class="content-box">
                <div class="content-box-item">
                    <p>
                        ...
                        <span class="float-right bold">{{
                            applyDataFormat(confirmationData.consentData.consent.expirationDateTime)
                            }}</span>
                    </p>
                </div>
                <br />
                ...
                <br />
                <div class="content-box-item">
                    <p v-if="confirmationData.consentData.consent.recurringConfiguration?.automatic">Valor à pagar</p>
                    <p v-if="confirmationData.consentData.consent.recurringConfiguration?.sweeping">Valor total de
                        transações</p>
                    <p v-if="confirmationData.consentData.consent.recurringConfiguration?.vrp">Limite máximo para
                        transação</p>
                    <p class="payment-amount">
                        R$ {{ confirmationData.consentData.consent.recurringConfiguration?.sweeping?.totalAllowedAmount
                            || confirmationData.consentData.consent.recurringConfiguration?.automatic?.amount
                            || confirmationData.consentData.consent.recurringConfiguration?.vrp?.transactionLimit }}
                    </p>
                </div>
            </div>
            <br />
            <h4>Dados do recebedor</h4>
            <div v-for="(creditor, index) in confirmationData.consentData.consent.creditors" :key="index">
                <div class="content-box">
