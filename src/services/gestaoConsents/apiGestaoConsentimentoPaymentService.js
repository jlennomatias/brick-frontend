...
export async function getConsentsPayments(params) {
  try {
    const response = await api.get(`/api/management/consents/v1/consents/payment/transmitions`, params);
...
export async function getConsentsPaymentId(id, params) {
  try {
    const response = await api.get(`/api/management/consents/v1/consents/payment/transmitions/${id}`, params);
    return response.data;
  } catch (error) {
...
export async function updateConsentPayment(id, data) {
  try {
    const response = await api.patch(`/api/management/consents/v1/consents/payment/transmitions/${id}`, data);
    return response.data;
  } catch (error) {
...
export async function deleteConsentPayment(id) {
  try {
    const response = await api.delete(`/api/management/consents/v1/consents/payment/transmitions/${id}`);
    return response.data;
  } catch (error) {
